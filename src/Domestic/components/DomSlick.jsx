...
const DomSlick = () => {
    ...
    const servicekey = "%2B5juZ2oo8p9fd9pgmKEEYLuIs4KE2JabN2JIjinKYJtXaVInvxjvQlFCIR9y8HHtHEpmLhqRtM7B" +
            "DNb2XsBMcw%3D%3D";
                ...
                <Slider {...settings}>
                    {
                        festival.map((v, index) => {
                          ...
                          return (
                                v.firstimage && <div className="d-flex justify-content-center">
                                    <a href={"festival/" + v.createdtime}>
                                        <img object-fit="fill" src={v.firstimage} width="400px" height="500px"/>
                                    </a>
                                </div>
                            )
                        })
